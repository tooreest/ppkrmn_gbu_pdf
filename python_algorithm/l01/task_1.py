...
def check_3(lst_obj):
    ...
    Сложность: !!!	O(len(lst_obj)) + n log n + 2*n + 1 >>	O(n log n)
    """
...
for j in (50, 500, 1000, 5000, 10000):
    ...
    # Не понял зачем нужен этот кортеж да и сам цикл, если на выходе
    # все равно список с количеством элементов равным последнему элементу кортежа.
    # Пляс ко всему, в исходнике последнее число было "1000"
